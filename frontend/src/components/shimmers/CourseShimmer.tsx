...
const CourseShimmer:React.FC = () => {
  return (
    ...
    <div className=' grid grid-cols-2 w-[100%] p-10 mx-auto md:grid-cols-4 gap-2'>
      {[...Array(8)].map((_, index) => (
        <Card key={index} color='gray' className="w-[100%] p-0 mx-auto relative overflow-hidden"  placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
          <div className="shimmer-wrapper">
            <div className="shimmer"></div>
          </div>
          <CardHeader shadow={false} floated={false} className=" h-[20vh] relative object-cover rounded-2xl mb-4 bg-gray-500" placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
    ...
    <Typography
              as="div"
              variant="paragraph"
              className="mb-2 h-2 w-20 rounded-full bg-gray-300"  placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}    >
      &nbsp;
    </Typography>              </CardBody>
          <CardFooter className="pt-0"  placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
            <Button disabled tabIndex={-1} className="shimmer-item h-8 w-20 bg-gray-300 shadow-none" placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} children={undefined}></Button>
          </CardFooter>
        </Card>
      ))}
    </div>
